...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Editar Ciudad') }}
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('ciudades.update', $ciudad->id) }}">
                            ...
                            <div class="col-md-6">
                                <select name="provincia_id" class="form-control" aria-label="Default select example">
                                    ...
                                    @foreach ($provincias as $provincia)
                                        <option value="{{$provincia->id}}" {{$provincia->id == $ciudad->provincia_id ? 'selected' : ''}}>{{$provincia->nombre}}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="nombre" type="text" class="form-control @error('nombre') is-invalid @enderror" name="nombre" value="{{ old('nombre', $ciudad->nombre) }}" required autocomplete="nombre" autofocus>
